                ...
                <div class="col-sm-12 col-md-12">
                    <div class="card card-accent-info">
                        ...
                        <div class="card-body row">
                            <div class="col-md-12">
                                <form id="createThingContentForm">
                                    @foreach($fields as $field)
                                        {!! build_detail_html($field) !!}
                                    @endforeach
                                </form>
                            </div>
                        </div>
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="form-group-actions col-md-9">
                                    <button class="btn btn-success btn-ladda ladda-button" data-style="zoom-out" id="createThingContentSubmit">
...
@push('scripts')
    ...
    <script>
        $(function(){
            $('#createThingContentSubmit').click(function(){
                // save rich text
                ...
                let data = $('#createThingContentForm').serializeJSON();

                z_ajax('post', '{{ route('storeContentThing', ['appId'=>$appId, 'thingId'=>$thingId, 'operationId'=>$operationId]) }}', data, function (response) {
