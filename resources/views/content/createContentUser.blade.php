                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="form-group-actions col-md-9">
                                    <button class="btn btn-success btn-ladda ladda-button" data-style="zoom-out" id="createContentUserSubmit">
...
@push('scripts')
    <script>
        $(function(){
            $('#createContentUserSubmit').click(function(){
                let ladda = Ladda.create(this).start();
                let data = $('#createContentUserForm').serializeJSON();

                z_ajax('post', '{{ route('storeContentUser', ['appId'=>$appId]) }}', data, function (response) {
