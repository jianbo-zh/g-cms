                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i> 编辑应用角色
                        </div>
                        <div class="card-body">
                            <form method="post" class="form-horizontal" id="editAppRoleForm">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="form-actions col-md-10">
                                    <button class="btn btn-primary btn-ladda ladda-button" data-style="zoom-out" id="editAppRoleSubmit">
...
<script>
    $(function () {
        ...
        $('#editAppRoleSubmit').click(function () {
            let formData = $('#editAppRoleForm').serializeJSON();
            let ladda = Ladda.create(this).start();
            z_ajax('put', '{{ route("updateAppRole", ['appId'=>$appId, 'roleId'=>$role['id']]) }}', formData, function (response) {
                ladda.stop();
