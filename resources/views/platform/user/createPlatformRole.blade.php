                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i> 创建平台角色
                        </div>
                        <div class="card-body">
                            <form method="post" class="form-horizontal" id="create-role-form">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="form-actions col-md-10">
                                    <button class="btn btn-primary btn-ladda ladda-button" data-style="zoom-out" id="create-role-submit">
...
<script>
    $(function () {
        ...
        $('#create-role-submit').click(function () {
            let formData = $('#create-role-form').serializeJSON();
            let ladda = Ladda.create(this).start();
            z_ajax('post', '{{ route("storePlatformRole") }}', formData, function (response) {
                ladda.stop();
