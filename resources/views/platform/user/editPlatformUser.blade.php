                ...
                <div class="col-sm-12 col-md-12">
                    <div class="card card-accent-info">
                        ...
                        <div class="card-body row">
                            <div class="col-md-8">
                                <form action="{{ route('updatePlatformUser', ['userId'=>$user['id']]) }}" method="post" id="updatePlatformUserForm">
                                    <div class="form-group row">
                                        <label class="col-md-2 col-form-label text-right" for="userType">类型</label>
                                        <div class="col-md-9">
                                            <select class="form-control" disabled="disabled">
                                                <option value="app_content">{{ $user['userTypeText'] }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="form-group-actions col-md-9">
                                    <button class="btn btn-success btn-ladda ladda-button" data-style="zoom-out" id="updatePlatformUserSubmit">
...
@push('scripts')
    <script>
        $(function(){
            $('#updatePlatformUserSubmit').click(function(){
                let ladda = Ladda.create(this).start();
                let data = $('#updatePlatformUserForm').serializeJSON();

                z_ajax('put', '{{ route('updatePlatformUser', ['userId'=>$user['id']]) }}', data, function (response) {
